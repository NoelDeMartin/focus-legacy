...
export enum Types {
    ...
    String = 'string',
    Boolean = 'boolean',
    Array = 'array', // requires attribute "each"
    Object = 'object',
    Date = 'date',
    Key = 'key',
}
...
interface FieldDefinition {
    ...
    // Used with Types.Array
    item?: FieldDefinition;

    // Used with Types.Object
    fields?: {
    ...
    public static boot<T extends Model>(name: string): void {
        ...
        if (typeof classDef.timestamps === 'boolean') {
            if (classDef.timestamps) {
                fieldDefinitions.created_at = { type: Types.Date, required: false, auto: true };
                fieldDefinitions.updated_at = { type: Types.Date, required: false, auto: true };
            }
            ...
            classDef.timestamps.each(field => {
                ...
                fieldDefinitions[field] = { type: Types.Date, required: false, auto: true };
            });
        }
